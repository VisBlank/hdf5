...
#define H5D_XFER_RING_SIZE      sizeof(unsigned)
#define H5D_XFER_RING_DEF       H5AC_RING_US
#define H5D_XFER_RING_ENC       H5P__encode_unsigned
#define H5D_XFER_RING_DEC       H5P__decode_unsigned
...
static const H5AC_ring_t H5D_ring_g = H5D_XFER_RING_DEC; /* Default value for the cache entry ring type */
