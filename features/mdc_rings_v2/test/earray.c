...
test_flush_depend(hid_t fapl, H5EA_create_t *cparam, earray_test_param_t H5_ATTR_UNUSED *tparam)
{
    ...
    base_addr = HADDR_MAX;
    if(H5AC_insert_entry(f, H5P_DATASET_XFER_DEFAULT, H5AC_EARRAY_TEST, base_addr, base_entry, H5AC__PIN_ENTRY_FLAG, H5AC_RING_US) < 0)
        TEST_ERROR
    ...
    /* Insert test entry into cache */
    addr1 = HADDR_MAX - 1;
    if(H5AC_insert_entry(f, H5P_DATASET_XFER_DEFAULT, H5AC_EARRAY_TEST, addr1, entry1, H5AC__PIN_ENTRY_FLAG, H5AC_RING_US) < 0)
        TEST_ERROR
    ...
    /* Insert test entry into cache */
    addr2 = HADDR_MAX - 2;
    if(H5AC_insert_entry(f, H5P_DATASET_XFER_DEFAULT, H5AC_EARRAY_TEST, addr2, entry2, H5AC__PIN_ENTRY_FLAG, H5AC_RING_US) < 0)
        TEST_ERROR
    ...
    /* Insert test entry into cache */
    addr3 = HADDR_MAX - 3;
    if(H5AC_insert_entry(f, H5P_DATASET_XFER_DEFAULT, H5AC_EARRAY_TEST, addr3, entry3, H5AC__PIN_ENTRY_FLAG, H5AC_RING_US) < 0)
        TEST_ERROR
    ...
    if(NULL == (base_entry = (earray_test_t *)H5AC_protect(f, H5P_DATASET_XFER_DEFAULT, H5AC_EARRAY_TEST, base_addr, NULL, H5AC__NO_FLAGS_SET, H5AC_RING_US)))
        TEST_ERROR
    ...
    if(NULL == (entry1 = (earray_test_t *)H5AC_protect(f, H5P_DATASET_XFER_DEFAULT, H5AC_EARRAY_TEST, addr1, NULL, H5AC__NO_FLAGS_SET, H5AC_RING_US)))
        TEST_ERROR
    ...
    /* Protect the test entry */
    if(NULL == (entry2 = (earray_test_t *)H5AC_protect(f, H5P_DATASET_XFER_DEFAULT, H5AC_EARRAY_TEST, addr2, NULL, H5AC__NO_FLAGS_SET, H5AC_RING_US)))
        TEST_ERROR
    ...
    /* Protect the test entry */
    if(NULL == (entry3 = (earray_test_t *)H5AC_protect(f, H5P_DATASET_XFER_DEFAULT, H5AC_EARRAY_TEST, addr3, NULL, H5AC__NO_FLAGS_SET, H5AC_RING_US)))
        TEST_ERROR
